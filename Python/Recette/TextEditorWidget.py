...
# https://doc.qt.io/qtforpython-6/examples/example_widgets_richtext_textedit.html
...
class TextEdit(QWidget):
    def __init__(self, parent=None):
        ...
        self.textEditToolbar = QToolBar()
        self.mainLayout.addWidget(self.textEditToolbar)
        self.textActionToolbar = QToolBar()
        self.mainLayout.addWidget(self.textActionToolbar)
        self.textFontToolbar = QToolBar()
        self.mainLayout.addWidget(self.textFontToolbar)
        self.mainLayout.addWidget(self._text_edit)
    ...
    def setup_edit_actions(self):
        ...
        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/editundo.png"))
        # self._action_undo = self.textEditToolbar.addAction(icon, "&Undo", self._text_edit.undo)
        self._action_undo = self.textEditToolbar.addAction("&Undo", self._text_edit.undo)
        self._action_undo.setShortcut(QKeySequence.StandardKey.Undo)
        # tb.addAction(self._action_undo)
        # self.textEditToolbar.addAction(self._action_undo)

        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/editredo.png"))
        self._action_redo = self.textEditToolbar.addAction("&Redo", self._text_edit.redo)
        self._action_redo.setPriority(QAction.Priority.LowPriority)
        self._action_redo.setShortcut(QKeySequence.StandardKey.Redo)
        # self.textEditToolbar.addAction(self._action_redo)
        # menu.addSeparator()

        # icon = QIcon.fromThemeQIcon(RSRC_PATH + "/editcut.png")
        self._action_cut = self.textEditToolbar.addAction("Cu&t", self._text_edit.cut)
        self._action_cut.setPriority(QAction.Priority.LowPriority)
        self._action_cut.setShortcut(QKeySequence.StandardKey.Cut)
        # self.textEditToolbar.addAction(self._action_cut)

        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/editcopy.png"))
        self._action_copy = self.textEditToolbar.addAction("&Copy", self._text_edit.copy)
        self._action_copy.setPriority(QAction.Priority.LowPriority)
        self._action_copy.setShortcut(QKeySequence.StandardKey.Copy)
        # self.textEditToolbar.addAction(self._action_copy)

        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/editpaste.png"))
        self._action_paste = self.textEditToolbar.addAction("&Paste", self._text_edit.paste)
        self._action_paste.setPriority(QAction.Priority.LowPriority)
        self._action_paste.setShortcut(QKeySequence.StandardKey.Paste)
        # self.textEditToolbar.addAction(self._action_paste)
    ...
    def setup_text_actions(self):
        # tb = self.textActionToolbar("Format self.actions")
        self._combo_font = QFontComboBox(self.textActionToolbar)

        # menu = self.menuBar().addMenu("F&ormat")

        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/textbold.png"))
        self._action_text_bold = self.textActionToolbar.addAction("&Bold", self.text_bold)
        ...
        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/textitalic.png"))
        self._action_text_italic = self.textActionToolbar.addAction("&Italic", self.text_italic)
        ...
        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/textunder.png"))
        self._action_text_underline = self.textActionToolbar.addAction("&Underline",
                                                     self.text_underline)
        ...
        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/textleft.png"))
        self._action_align_left = QAction("&Left", self)
        ...
        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/textcenter.png"))
        self._action_align_center = QAction("C&enter", self)
        ...
        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/textright.png"))
        self._action_align_right = QAction("&Right", self)
        ...
        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/textjustify.png"))
        ...
        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/format-indent-more.png"))
        self._action_indent_more = self.textActionToolbar.addAction("&Indent", self.indent)
        ...
        # icon = QIcon.fromTheme(QIcon(RSRC_PATH + "/format-indent-less.png"))
        self._action_indent_less = self.textActionToolbar.addAction("&Unindent",
                                                  self.unindent)
        ...
        self.textActionToolbar.addActions(align_group.actions())
        # menu.addActions(align_group.actions())
        # self.textActionToolbar.addAction(self._action_indent_more)
        # self.textActionToolbar.addAction(self._action_indent_less)
        ...
        self._action_text_color = self.textActionToolbar.addAction(pix, "&Color...", self.text_color)
        # tb.addAction(self._action_text_color)

        # icon = QIcon(RSRC_PATH + "/textundercolor.png")
        self._action_underline_color = self.textActionToolbar.addAction("Underline color...",
        ...
        self._action_toggle_check_state = self.textActionToolbar.addAction("Chec&ked")
        ...
        self.textFontToolbar.setAllowedAreas(Qt.ToolBarArea.TopToolBarArea | Qt.ToolBarArea.BottomToolBarArea)
        # self.addToolBarBreak(Qt.ToolBarArea.TopToolBarArea)
        # self.addToolBar(tb)

        self._combo_style = QComboBox(self.textFontToolbar)
        self.textFontToolbar.addWidget(self._combo_style)
        self._combo_style.addItems(STYLES)

        self._combo_style.activated.connect(self.text_style)


        self.textFontToolbar.addWidget(self._combo_font)
        self._combo_font.textActivated.connect(self.text_family)

        self._combo_size = QComboBox(self.textFontToolbar)
        self._combo_size.setObjectName("comboSize")
        self.textFontToolbar.addWidget(self._combo_size)
